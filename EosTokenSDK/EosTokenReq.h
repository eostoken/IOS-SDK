 ...
 * @brief 基础数据
 */
@interface EosTokenReq : NSObject
...
#pragma mark - 登录
/*!
 * @class EosTokenLoginReq
 * @brief 登录附加数据
 */
@interface EosTokenLoginReq : EosTokenReq
...
#pragma mark - 转账
/*!
 * @class EosTokenTransferReq
 * @brief 转账附加数据
 */
@interface EosTokenTransferReq : EosTokenReq
...
/*!
 * @class EosTokenTransactionReq
 * @brief 自定义Trasaction数据
 */
@interface EosTokenTransactionReq : EosTokenReq
...
#pragma mark - 消息签名
/*!
 * @class EosTokenSignMessageReq
 * @brief 消息签名
 */
@interface EosTokenSignMessageReq : EosTokenReq
...
#pragma mark - 跳转URL
/*!
 * @class EosTokenOpenURLReq
 * @brief 跳转到指定DApp
 */
@interface EosTokenOpenURLReq : EosTokenReq
